...
// Vanilla runs the original 30Hz logic and the original render cadence. The high
// frame rate work targets the Zero Hour online client, whose lobbies vanilla never
// joins, so neither the 60Hz server nor the render unlock is enabled here.
...
// Sentry is a Zero Hour only dependency; vanilla links the stub-free build.
