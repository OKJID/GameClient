...
#ifdef __APPLE__
		// The file stores 16-bit characters, but WideChar is 32-bit here, so
		// reading straight into the buffer would consume twice the bytes and
		// desynchronise everything that follows in the chunk.
