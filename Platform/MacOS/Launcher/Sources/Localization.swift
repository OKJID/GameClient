...
enum L10n {
    ...
    static let en: [String: String] = [
        ...
        "settings.scope.offlineDesc": "OFFLINE: Skirmish, Campaign, Generals Challenge and Replays. Not used in network games (Online, LAN).",
    ...
    static let ru: [String: String] = [
        ...
        "settings.scope.offlineDesc": "ОФЛАЙН: Сражение, Кампания, Испытание генералов и Реплеи. В сетевых играх (Онлайн, LAN) не действует.",
    ...
    static let uk: [String: String] = [
        ...
        "settings.scope.offline": "ОФЛАЙН",
        "settings.scope.offlineDesc": "ОФЛАЙН: Сутичка, Кампанія, Випробування генералів і Реплеї. У мережевих іграх (Онлайн, LAN) не діє.",
        "settings.legendSection": "ЛЕГЕНДА",
    ...
    static let hi: [String: String] = [
        ...
        "settings.scope.offlineDesc": "ऑफ़लाइन: झड़प, अभियान, जनरल्स चैलेंज और रीप्ले। नेटवर्क गेम (ऑनलाइन, LAN) में लागू नहीं होता।",
    ...
    static let zh: [String: String] = [
        ...
        "settings.scope.offlineDesc": "离线：遭遇战、战役、将军挑战和录像。网络游戏（在线、局域网）中不生效。",
    ...
    static let kk: [String: String] = [
        ...
        "settings.scope.offline": "ОФЛАЙН",
        "settings.scope.offlineDesc": "ОФЛАЙН: Шайқас, науқан, генералдар сынағы және реплейлер. Желілік ойындарда (онлайн, LAN) қолданылмайды.",
    ...
    static let vi: [String: String] = [
        ...
        "settings.scope.offlineDesc": "NGOẠI TUYẾN: Trận đấu, Chiến dịch, Thử thách Tướng và Phát lại. Không áp dụng trong trò chơi mạng (Trực tuyến, LAN).",
    ...
    static let pl: [String: String] = [
        ...
        "settings.scope.offline": "OFFLINE",
        "settings.scope.offlineDesc": "OFFLINE: Potyczka, kampania, wyzwanie generałów i powtórki. Nie działa w grach sieciowych (online, LAN).",
    ...
    static let de: [String: String] = [
        ...
        "settings.scope.offline": "OFFLINE",
        "settings.scope.offlineDesc": "OFFLINE: Gefecht, Kampagne, Generals-Herausforderung und Wiederholungen. Gilt nicht in Netzwerkspielen (Online, LAN).",
    ...
    static let es: [String: String] = [
        ...
        "settings.scope.offlineDesc": "SIN CONEXIÓN: Escaramuza, Campaña, Desafío de generales y Repeticiones. No se aplica en partidas en red (En línea, LAN).",
    ...
    static let tr: [String: String] = [
        ...
        "settings.scope.offlineDesc": "ÇEVRİMDIŞI: Çatışma, Sefer, General Mücadelesi ve Tekrarlar. Ağ oyunlarında (Çevrimiçi, LAN) geçerli değildir.",
