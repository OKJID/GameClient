...
MacOSKeyboard::MacOSKeyboard(void) {
  m_nextFreeIndex = 0;
  m_nextGetIndex = 0;
  m_lastFlags = 0;
}
...
void MacOSKeyboard::init(void) {
  Keyboard::init();
  reset();
}

void MacOSKeyboard::reset(void) {
  m_nextFreeIndex = 0;
  m_nextGetIndex = 0;
...
void MacOSKeyboard::addEvent(unsigned char keyCode, bool isDown,
                           unsigned int time) {
...
void MacOSKeyboard::setModifiers(unsigned long flags, unsigned int time) {
